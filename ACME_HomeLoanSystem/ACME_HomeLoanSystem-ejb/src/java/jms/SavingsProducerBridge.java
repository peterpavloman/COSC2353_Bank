...
/**
 * Provides an interface of business-logic related methods that are performed on
 * the Assignment1 Savings system.
 *
...
public abstract interface SavingsProducerBridge
{
	 ...
	 */
	public abstract boolean withdrawFromSavingsAccount(int aIDSavingsAccount,
			BigDecimal aAmount) throws ApplicationLogicException;

	public abstract Savings getSavingsDetails(int aIDSavings)
			throws ApplicationLogicException;

	public abstract boolean verifyCustomerLogin(int aIDCustomer,
			String aPassword)
			throws ApplicationLogicException;
	...
	public abstract BigDecimal getTotalSavingsBalance() throws ApplicationLogicException;
